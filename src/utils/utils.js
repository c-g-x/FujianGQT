...
export function RSAEncrypt(word) {
  ...
  encryptRsa = RsaArr.KEYUTIL.getKey(
    '-----BEGIN PUBLIC KEY-----MFwwDQYJKoZIhvcNAQEBBQADSwAwSAJBAKf9iZkA5HEFw4zt7MRBkcmgUiz5+r5eqDOKbaurEbScmXd3ZZTtyzirqkYKRIH5mQ+8hq+Wd/pTZNXHS8L0+88CAwEAAQ==-----END PUBLIC KEY-----'
  );
